...
Welcome to my profile. I hope you will enjoy and benefit from being here, as much as I do.
The purpose of this profile is to help to grow.
And growing together is growing fast. 
This profile is created for learning and sharing knowledge.
I use it to gather my side projects, which I use to learn implementing new methodologies and technologies.
It exists to be a structured summary of my learning effort.
It's here for passion, having fun, and share this passion with others.
And it exists for you to find out what do I focus on as a passionate software developer, if you're only interrested.
Because I believe that only practicing regularly makes you strong and confident of your future.
Let's share the passion to grow together!

> The difference between ordinary and extraordinary is practice
>
> -- [Vladimir Howowitz](https://en.wikipedia.org/wiki/Vladimir_Horowitz)
...
And I totally loved it since the first class. It was the moment when I realized what do I want to do for living and for fun.
When I started colledge, [Cracow University of Technology](https://www.pk.edu.pl), Computer Science, I was sure I'll stay close to the hardware, programming low level (I loved Assembly!) and will never be a web developer.
...
They tought me to work hard and play hard, as social life is important for everyone, including software engineers.
They tought me that EnvironmentVariablesTable could probably be a better name for a Java class than MCTable (an abbreviation for Marcin Ciapa Table).
...
I learnt some UI development, struggling a lot with my lack aesthetic sense.
...
In 2018 I joined [Smart Recruiters](https://www.smartrecruiters.com/), having that fresh experience of moving from tens of thousands headcount company to the startup hiring ~100 engineers.
...
My technologies were mostly Java and a lot of databases (Postgres, Oracle, Amazon Redshift, Google BigQuery, Elastic Search, Solr). 
...
And here I am now. Still loving the feeling of joy when 'It works!' after adding yet another line of code.

## My skillset
| Skill           | Rate                                                                   |
|-----------------|------------------------------------------------------------------------|
| Java            | :green_circle::green_circle::green_circle::white_circle::white_circle: |
| Spring          | :green_circle::green_circle::white_circle::white_circle::white_circle: |
| Hibernate/JPA   | :green_circle::green_circle::white_circle::white_circle::white_circle: |
...
| Elastic Search  | :green_circle::green_circle::white_circle::white_circle::white_circle: |
...
It requires inserting activities, inluding their start and end time, to analyze and visualize them.
...
- [actracker-search-feeder](https://github.com/marcinciapa/actracker-search-feeder) - an event listener responsible for ingesting data to the search engine after they change
...
Except functional part, the application is a sandbox to practice the software engineering techniques and technologies, like: DDD, persistence, messaging, Elastic Search, Kubernetes, Angular.
...
## My learnings
Here's the log of my learnings, devided by months. Feel free to spy my on my progress.
