...
- Benefits of using TDD:
  - *Certainty*, enough to ship
  - *Defect injection rate* lowers
  - *Courage* to change the messy code
  - *Documentation* by examples of usage
  - *Design* enforced by interactions with other objects
